			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbarNavDropdown">
					<ul class="navbar-nav">
						...
						<li class="nav-item"><a class="nav-link" href="<%=url%>EditorialesController?op=listar">Editorial</a>
						</li>
						<li class="nav-item"><a class="nav-link" href="<%=url%>LibrosController?op=listar">Libros</a>
						</li>
